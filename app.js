...
const PhoneNumberRouter = require("./Router/PhoneNumberRouter.js");
const SendMessagesRouter = require("./Router/SendMessagesRouter.js");
const ResetPasswordRouter = require("./Router/ResetPasswordRouter.js");
const CodeRouter = require("./Router/CodeRouter.js");
const app = express();
...
app.use("/phone", PhoneNumberRouter);
app.use("/sendmessage", SendMessagesRouter);
app.use("/changepassword", ResetPasswordRouter);//use
